...
const THEMES = [
  {
    id: "midnight-navy",
    label: "Spatial Materialism",
    icon: "🌌",
    description: "Deep navy with material depth",
  },
  {
    id: "solaris",
    label: "Amoebic UI",
  ...
  },
  {
    ...
    label: "Brutalist",
    icon: "🏙️",
    description: "Raw, high-contrast urban",
  },
  {
    id: "arctic-dawn",
    label: "Tokyo Night",
    icon: "🌙",
    description: "Cool purples and teals",
  },
  {
    id: "light",
    label: "Arctic Dawn",
    icon: "🌅",
    description: "Bright, crisp morning",
  },
] as const;
...
function ThemePreviewCard(props: {
  ...
  return (
    <div
      class={`rounded-[var(--radius-md)] border p-4 transition-all ${
        props.isActive
    ...
    >
      ...
      <div class="flex gap-2">
        ...
        <div
          class="h-4 w-4 rounded-full bg-[var(--bg-card)] border border-[var(--border)]"
          title="Card"
        />
        <div
          class="h-4 w-4 rounded-full bg-[var(--bg-secondary)] border border-[var(--border)]"
          title="Secondary"
        />
        <div
          class="h-4 w-4 rounded-full bg-[var(--text-primary)]"
          title="Text Primary"
        />
        <div
          class="h-4 w-4 rounded-full bg-[var(--text-secondary)]"
    ...
    <div class="space-y-6">
      ...
      <section>
        ...
        <p class="text-xs text-[var(--text-secondary)] mb-2">
          ...
          <code class="rounded bg-[var(--bg-secondary)] px-1.5 py-0.5">
            localStorage
          </code>{" "}
          under{" "}
          <code class="rounded bg-[var(--bg-secondary)] px-1.5 py-0.5">
        ...
        <div class="rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--bg-secondary)] p-3">
          <code class="text-xs text-[var(--text-primary)]">
