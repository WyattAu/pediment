...
export default function AccordionDemo() {
  ...
  const items = [
    {
      id: "1",
      title: "What is Pediment?",
      content:
        "Pediment is a shared design system with tokens, components, hooks, and utilities for Astro + SolidJS projects.",
    },
    {
      id: "2",
      title: "How do I install it?",
      content:
        "Add pediment as a workspace dependency in your package.json and import the tokens and components you need.",
    },
    {
      id: "3",
